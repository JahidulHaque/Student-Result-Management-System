...
<br>
		<div class="aa">
			...
			<button class="btn btn-primary" onclick="window.location.href='viewallmark.php';">View Marks Term Wise</button>
		</div>
		<div class="aa">
			
			<button class="btn btn-primary" onclick="window.location.href='custommark.php';">View Marks Semester Wise</button>
		</div>
		<br>
			<div class="a">
